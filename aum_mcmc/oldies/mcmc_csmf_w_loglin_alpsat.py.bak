...
if __name__ == "__main__":
    ...
    for i,bb in enumerate(range(4,11)):
        ...
        dat  = np.loadtxt('./jk_preet_hsc_no_deblend_output_cosmo_y08/dsigma.dat_%d'%bb)
        rdat = np.loadtxt('./jk_preet_hsc_no_deblend_rand_output_cosmo_y08/dsigma.dat_%d'%bb)
    ...
    cov = cov[30:, 30:] #removing first 3 bins
    ...
    Nburn=5000
    pos = runchain(Nburn,sampler,"./jk_preet_hsc_no_deblend_output_cosmo_y08_fits/burnfile.dat_bosch_2013_removed_first_3_bins_loglin_alpsat","./jk_preet_hsc_no_deblend_output_cosmo_y08_fits/burnpredfile.dat_bosch_2013_removed_first_3_bins_loglin_alpsat",p_0);
    
    sampler.reset();
    
    Ntotal=10000
    posfinal = runchain(Ntotal,sampler,"./jk_preet_hsc_no_deblend_output_cosmo_y08_fits/chainfile.dat_bosch_2013_removed_first_3_bins_loglin_alpsat","./jk_preet_hsc_no_deblend_output_cosmo_y08_fits/predfile.dat_bosch_2013_removed_first_3_bins_loglin_alpsat", pos);
    pool.close()
